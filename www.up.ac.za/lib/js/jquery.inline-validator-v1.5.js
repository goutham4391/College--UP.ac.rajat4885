...
_inline_regex['sa_phone'] = /^((?:\+27|27)|0)(\d{2})-?(\d{3})-?(\d{4})$/;
_inline_regex['noNum'] = /^[^0-9]*$/;
_inline_regex['min3'] = /^[0-9A-Za-z\s]{3,}$/;
_inline_regex['min2NoNum'] = /^[^0-9]{2,}$/;
_inline_regex['min3NoNum'] = /^[^0-9]{3,}$/;
 
_inline_regex['name'] = /^[a-zA-Z -\/.,0-9]*$/;
_inline_regex['address'] = /^([0-9])+([0-9a-zA-Z -\/.,#])*$/;
_inline_regex['letters'] = /^[a-zA-Z]*$/;
//_inline_regex['email'] = /^[\_]*([a-zA-Z0-9\-]+(\.|\_*)?)+@([a-zA-Z0-9][A-Za-z0-9\-]+(\.|\-*\.))+[a-zA-Z]{2,6}$/;
_inline_regex['email'] = /^[A-Za-z0-9_\+-]+(\.[A-Za-z0-9_\+-]+)*@[A-Za-z0-9-]+(\.[A-Za-z0-9-]+)*\.([A-Za-z]{2,4})$/, //// will pass "normal looking" addresses like foo.bar@baz.example.com or foo+bar@example.com. This regexp won't, however, pass all syntactically valid addresses like foo,!#@example.com -- modified to allow for case sensitivity, with thanks http://www.markussipila.info/pub/emailvalidator.php?action=validate
...
_inline_regex['password'] = /(?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$/;
_inline_regex['strong-password'] = /(?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$/;
_inline_regex['weak-password'] = /(?=^.{6,}$)(?=.*[A-Z])(?=.*[a-z]).*$/;
_inline_regex['medium-password'] = /(?=^.{6,}$)(?=.*\d)(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$/;
_inline_regex['average-password'] = /(?=^.{8,}$)(?=.*\d)(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$/;
_inline_regex['very-strong-password'] = /(?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$/;
	...
	$.fn.extend({	
		...
		*/
		...
		validate: function(options) {
			...
			if(options.placeholder && $t._val(options) == '')
				$t.placeholder();
			else
				if(options.reset)
					$t.attr('placeholder', '');				
